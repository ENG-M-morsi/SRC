...
HR_IMAGE_FILENAME = "GakuenNoise.png"              # <-- غيّر اسم الملف بس هنا
...
CROP_BOX = (461, 330, 609,450)                 # <-- عدّل الأرقام دي حسب صورتك
...
MODELS = [
    ("HR",        "GakuenNoise.png"),
    ("Bicubic",         "GakuenNoise_bicubic.png"),
    ("DHTCUN",         "GakuenNoise_DHTCUN.png"),
    ("DAT",            "GakuenNoise_DAT.png"),
    ("ELAN",           "GakuenNoise_ELAN.png"),
    ("HAT",            "GakuenNoise_HAT.png"),
    ("OmniSR",         "GakuenNoise_OmniSR.png"),
    ("SRFormer",         "GakuenNoise_SRFormer.png"),
    ("SwinT",         "GakuenNoise_SwinT.png"),
    ("Wavelet",         "GakuenNoise_Wavelet.png"), 
]

# --- 5) كام عمود في الشبكة (عدد الصور جنب بعض في الصف الواحد) ---
GRID_COLS = 5                                    # <-- عدد الأعمدة (راجع الشرح تحت للسؤال 6)
