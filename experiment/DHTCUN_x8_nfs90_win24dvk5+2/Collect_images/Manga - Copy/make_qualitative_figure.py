...
HR_IMAGE_FILENAME = "ShimatteIkouze_vol01.png"

# إحداثيات منطقة الاقتصاص (x_left, y_top, x_right, y_bottom) 
CROP_BOX = (356, 243, 462, 291)
...
MODELS = [
    ("HR",        "ShimatteIkouze_vol01.png"),     
    ("Bicubic",       "ShimatteIkouze_vol01_bicubic.png"),
    ("DHTCUN",         "ShimatteIkouze_vol01_DHTCUN.png"),
    ("DAT",             "ShimatteIkouze_vol01_DAT.png"),
    ("ELAN",           "ShimatteIkouze_vol01_ELAN.png"),
    ("HAT",             "ShimatteIkouze_vol01_HAT.png"),
    ("OmniSR",          "ShimatteIkouze_vol01_OmniSR.png"),
    #("SRFormer",      "ShimatteIkouze_vol01_SRFormer.png"),
    ("SwinT2",           "ShimatteIkouze_vol01_SwinT.png"),
    #("Wavelet",          "ShimatteIkouze_vol01_Wavelet.png"),
]
