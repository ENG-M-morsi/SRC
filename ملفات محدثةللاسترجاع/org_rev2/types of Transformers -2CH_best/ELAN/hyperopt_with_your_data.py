...
# ===================================================================
# تحميل البيانات (مع نسخ args وضبط المسار والمدى)
# ===================================================================
def get_loaders_from_args(trial_params, base_args):
    args = copy.deepcopy(base_args)
    # ضبط الإعدادات كقائمة لأن data/__init__.py يتوقع قائمة
    args.data_train = ['DIV2K']
    args.data_test = ['DIV2K']
    args.data_range = '1-800/896-900'
    args.scale = [4]  # يجب أن تكون قائمة أعداد صحيحة
...
def objective(trial):
    ...
    window_size = trial.suggest_categorical('window_size', [4, 8, 12])
    ...
    # ✅ إعادة تعريف ELAN داخل كل TCN بالمعاملات الجديدة
