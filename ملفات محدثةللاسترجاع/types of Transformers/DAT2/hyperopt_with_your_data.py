# ===================================================================
# hyperopt_with_your_data.py — بحث شامل مع DAT (محسّن)
# ===================================================================
import optuna
import torch
...
# ===================================================================
# 2. دالة لإنشاء DataLoaders (معدلة للتعامل مع الأخطاء)
# ===================================================================
def get_loaders_from_args(trial_params, base_args):
    ...
    args.dir_data = r'D:\Mohamed Morsi PhD- P2\Ph.D Server\Ph.D\Image Processing\DHTCUN-main\Dataset'
...
# ===================================================================
# 3. دالة الهدف الرئيسية (Objective) مع تنظيف الذاكرة
# ===================================================================
def objective(trial):
    ...
    # ---------- (ج) بناء النموذج ----------
    model = HUTCN(in_nc=3, nf=nf, num_modules=num_modules, out_nc=3, upscale=4, num_heads=num_heads )
    ...
    try:
        ...
        if val_loader is None or len(train_loader) == 0:
            raise optuna.TrialPruned()
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        avg_psnr = psnr_sum / len(val_loader) if len(val_loader) > 0 else 0.0
