# ===================================================================
# hyperopt_with_your_data.py — بحث شامل مع OmniSR و HUTCN
# ===================================================================
import optuna
import torch
...
def objective(trial):
    ...
    ws = trial.suggest_categorical('ws', [4, 6, 8, 12, 16])
    ...
    # ✅ استبدال OmniSR في كل TCN بالمعاملات الجديدة
    for module in model.modules():
        if isinstance(module, B.TCN):
            # استبدال omnisr بالكامل
