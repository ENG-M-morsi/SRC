...
HR_IMAGE_FILENAME = "GOOD_KISS_Ver2.png"

# إحداثيات منطقة الاقتصاص (x_left, y_top, x_right, y_bottom) 
CROP_BOX = (314, 144, 420,185)
...
MODELS = [
    ("HR",        "GOOD_KISS_Ver2.png"),     
    ("Bicubic",       "GOOD_KISS_Ver2_bicubic.png"),
    ...
    #("SRFormer",      "GOOD_KISS_Ver2_SRFormer.png"),
    ("SwinT2",           "GOOD_KISS_Ver2_SwinT.png"),
...
OUTPUT_FILENAME = "Fig_qualitative_GOOD_KISS_Ver2_x8.jpg"
JPEG_QUALITY = 95
