...
MODELS = [
    ("HR",        "img049.png"),     
    ("Bicubic",       "img049_bicubic.png"),
    ("DHTCUN",         "img049_DHTCUN.png"),
    ("DAT",             "img049_DAT.png"),
    ("ELAN",           "img049_ELAN.png"),
    ("HAT",             "img049_HAT.png"),
    ("OmniSR",          "img049_OmniSR.png"),
    #("SRFormer",      "img049_SRFormer.png"),
    ("SwinT2",           "img049_SwinT.png"),
    #("Wavelet",          "img049_Wavelet.png"),
]
...
OUTPUT_FILENAME = "Fig_qualitative_img049_x8.jpg"
JPEG_QUALITY = 95
