...
class P_HTCB(nn.Module):
    ...
    def __init__(self, in_channels):
        ...
        #self.cnn_branch = CNN_Block(in_channels)
        self.trans_branch = Transformer_Block(in_channels)
