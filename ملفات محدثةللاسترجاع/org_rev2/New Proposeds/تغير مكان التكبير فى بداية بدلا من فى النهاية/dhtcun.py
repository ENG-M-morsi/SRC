...
class HUTCN(nn.Module):
    def __init__(self, in_nc=3, nf=50, num_modules=4, out_nc=3, upscale=3):
        ...
        self.B2 = B.P_HTCB(in_channels=nf,upscale=upscale)
        self.B3 = B.P_HTCB(in_channels=nf,upscale=upscale)
        self.B4 = B.P_HTCB(in_channels=nf,upscale=upscale)
        self.B5 = B.P_HTCB(in_channels=nf,upscale=upscale)
