...
from model.custom_attention_blocks import ELAN  # ✅ استيراد ELAN
...
def objective(trial):
    ...
    # ---------- بناء النموذج ----------
    # ملاحظة: HUTCN في النموذج الجديد لا يأخذ num_heads
